...
def home():
    return (
        ...
        f"/api/v1.0/tobs</br>"
        f"</br>"
        f"To query minimum, average, and maximum values, append the start date in form XXXX-XX-XX to the below URL and append it to the end of your current URL. If you would like to specify and end date, add an end date to the end in the form /XXXX-XX-XX"
        f"</br>"
        f"/api/v1.0/"
...
def precip():
    ...
    data_plot = list(np.ravel(year_precipitation))
